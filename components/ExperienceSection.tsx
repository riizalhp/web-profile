...
function ToolsCard() {
  const tools = [
    ...
    { name: "Figma", icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50" {...props}>
    ...
    { name: "React", icon: (props: React.SVGProps<SVGSVGElement>) => (
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 28 28" {...props}>
      ...
      <div className="flex flex-wrap justify-center gap-x-4 sm:gap-x-6 gap-y-2 items-center">
        {tools.map((tool, index) => (
          <React.Fragment key={index}>
            ...
            <div className="tool-item cursor-hover flex-shrink-0">
