export const translations = {
  en: {
    meta: {
      home: {
        title: 'riizalhp. | Professional & Modern Website Creation Services',
        description: 'riizalhp. is a professional website creation service that turns your ideas into reality. Solutions for SMEs, personal branding, and corporations.',
        keywords: 'website creation service, web developer, riizalhp, professional website, sme, yogyakarta',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-home.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'WebSite', 'name': 'riizalhp.' }
      },
      about: {
        title: 'About Me | riizalhp. - Project Manager & Web Developer',
        description: 'Learn about Rizal Hanifa Pratama, a project manager and web developer based in Yogyakarta. Explore my experience, skills, and past projects.',
        keywords: 'Rizal Hanifa Pratama, project manager, web developer, Yogyakarta, portfolio, contsol dev',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-about.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'ProfilePage', 'name': 'About Rizal Hanifa Pratama' }
      },
      works: {
        title: 'My Works | Portfolio of riizalhp.',
        description: 'Explore my portfolio of web design, branding, and development projects. See how I help clients achieve their digital goals.',
        keywords: 'riizalhp portfolio, web design examples, branding projects, website development',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-works.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'CollectionPage', 'name': 'My Works' }
      },
      howWeWork: {
        title: 'My Workflow | riizalhp.',
        description: 'Discover my transparent and efficient workflow, from initial consultation and strategy to design, development, and launch.',
        keywords: 'website development process, riizalhp workflow, ui/ux design, web development steps',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-workflow.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'WebPage', 'name': 'My Workflow' }
      },
      articles: {
        title: 'Articles | riizalhp. - Web Dev & Digital Strategy Insights',
        description: 'Read my articles on web development, design trends, SEO, and digital business strategies to stay ahead in the digital world.',
        keywords: 'web development blog, digital strategy, seo tips, riizalhp articles',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-articles.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'Blog', 'name': 'riizalhp. Articles' }
      },
      pricing: {
        title: 'Pricing & Packages | riizalhp. Website Services',
        description: 'Transparent and flexible pricing for website creation. Find the perfect plan for your personal brand, SME, or enterprise needs.',
        keywords: 'website pricing, web development cost, riizalhp packages, affordable website',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-pricing.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'WebPage', 'name': 'Pricing' }
      },
      contact: {
        title: 'Contact Me | Get in Touch with riizalhp.',
        description: 'Have a project in mind? Contact riizalhp. via email or WhatsApp to discuss your website needs and get a free consultation.',
        keywords: 'contact riizalhp, get a quote, web developer contact, website consultation',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-contact.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'ContactPage', 'name': 'Contact Me' }
      }
    },
    // Navbar & Shared
    navStudio: 'about me',
    ...
    pricing: {
      ...
      packages: {
        personal: [
          { name: 'Economy Personal', description: 'For students or fresh graduates needing a simple online profile.', originalPrice: '$35', price: '$25', priceNote: '', features: ['Free domain (.my.id/.web.id/.site/.online)', 'Domain upgrade: .com (+$20), .id (+$25)', 'Landing Page (custom sections)', 'Premium Template Design', 'Responsive & mobile-friendly design', 'Contact Form (WA/Email)', '2x Minor revisions', 'Free hosting for 12 months', '3 months maintenance'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.my.id/.web.id)', 'Template', '—', '2x Minor', '—', '1 Year', 'Custom', '1 Page', '3 Months'] },
          { name: 'Starter Personal', description: 'For individuals starting to build their personal brand seriously.', originalPrice: '$100', price: '$65', priceNote: '', features: ['Free domain (.my.id/.web.id)', 'Domain upgrade: .com (+$20), .id (+$25)', 'Landing Page (custom sections)', 'Custom design according to brand', 'Basic SEO', 'Google Analytics integration', '3x Minor revisions', 'Free hosting for 12 months', '3 months maintenance'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.my.id/.web.id)', 'Custom', 'Basic', '3x Minor', '✓', '1 Year', 'Custom', '1 Page', '3 Months'] },
          { name: 'Business Personal', description: 'For freelancers, tutors, or personal brands wanting a professional look.', originalPrice: '$200', price: '$130', priceNote: '', popular: true, features: ['Premium .com or .id domain', 'Multi-page website (Home, About, etc.)', 'Mini blog for articles', 'Custom design according to brand', 'Complete SEO optimization', 'Google Analytics integration', '5x Minor + 1x Major revision', 'Free hosting for 12 months', '1-year full maintenance & support'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.com or .id)', 'Custom', 'Complete', '5x Minor + 1x Major', '✓', '1 Year', 'Custom', 'Multi-page', '1 Year'] },
        ...
        sme: [
          { name: 'Economy SME', description: 'For new SMEs or small businesses wanting an online presence.', originalPrice: '$50', price: '$35', priceNote: '', features: ['Free domain (.my.id/.web.id/.site/.online)', 'Domain upgrade: .com (+$20), .id (+$25)', 'Landing Page (custom sections)', 'Ready-to-use template design', 'Responsive & mobile-friendly design', 'Contact Form (WA/Email)', '2x Minor revisions', 'Free hosting for 12 months', '3 months maintenance'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.my.id/.web.id)', 'Template', '—', '2x Minor', '—', '1 Year', 'Custom', '1 Page', '3 Months'] },
          { name: 'Starter SME', description: 'For SMEs ready to seriously reach customers online.', originalPrice: '$150', price: '$100', priceNote: '', features: ['Free domain (.my.id/.web.id)', 'Domain upgrade: .com (+$20), .id (+$25)', 'Complete Landing Page (custom sections)', 'Custom design according to brand', 'Order Form (WA/Email)', 'Basic SEO', 'Google Analytics integration', '3x Minor revisions', 'Free hosting for 12 months', '3 months maintenance'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.my.id/.web.id)', 'Custom', 'Basic', '3x Minor', '✓', '1 Year', 'Custom', '1 Page', '3 Months'] },
          { name: 'Business SME', description: 'The best choice for SMEs needing a more professional website.', originalPrice: '$300', price: '$200', priceNote: '', popular: true, features: ['Premium .com or .id domain', 'Multi-page website', 'Simple product catalog / online booking', 'Custom design according to brand', 'Contact & order forms', 'Complete SEO optimization', 'Google Analytics integration', '5x Minor + 1x Major revision', 'Free hosting for 12 months', '1-year full maintenance & support'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.com or .id)', 'Custom', 'Complete', '5x Minor + 1x Major', '✓', '1 Year', 'Custom', 'Multi-page', '1 Year'] },
        ...
        enterprise: [
          { name: 'Economy Enterprise', description: 'For small companies or organizations needing an online profile.', originalPrice: '$70', price: '$50', priceNote: '', features: ['Free domain (.my.id/.web.id/.site/.online)', 'Domain upgrade: .com (+$20), .co.id (+$30)', 'Landing Page (custom sections)', 'Professional template design', 'Responsive & mobile-friendly design', 'Contact Form', '2x Minor revisions', 'Free hosting for 12 months', '3 months maintenance'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.my.id/.web.id)', 'Template', '—', '2x Minor', '—', '1 Year', 'Custom', '1 Page', '3 Months'] },
          { name: 'Starter Enterprise', description: 'For companies wanting to display a professional official profile.', originalPrice: '$250', price: '$165', priceNote: '', features: ['Premium .co.id or .id domain', 'Multi-page website', 'Special corporate sections', 'Custom design according to corporate branding', 'Basic SEO optimization', 'Google Analytics integration', '3x Minor revisions', 'Free hosting for 12 months', '3 months maintenance'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.co.id atau .id)', 'Custom', 'Basic', '3x Minor', '✓', '1 Year', '✓', 'Multi-page', '3 Months'] },
          { name: 'Business Enterprise', description: 'The best choice for mid-sized companies with interactive features.', originalPrice: '$500', price: '$330', priceNote: '', popular: true, features: ['Premium .co.id or .id domain', 'Multi-page website (incl. Careers)', 'Optional features (Login, Booking, Ticketing)', 'Custom design according to brand guidelines', 'Complete SEO optimization', '5x Minor + 1x Major revision', 'Free hosting for 12 months', '1-year full maintenance & support'], buttonText: 'Choose Plan', comparisonValues: ['✓ (.co.id or .id)', 'Custom', 'Complete', '5x Minor + 1x Major', '✓', '1 Year', 'Custom', 'Multi-page', '1 Year'] },
  ...
  id: {
    meta: {
      ...
      works: {
        title: 'Karya Saya | Portofolio riizalhp.',
        description: 'Jelajahi portofolio proyek desain web, branding, dan pengembangan saya. Lihat bagaimana saya membantu klien mencapai tujuan digital mereka.',
        keywords: 'portofolio riizalhp, contoh desain web, proyek branding, pengembangan website',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-works.jpg',
        jsonLd: { '@context': 'https://schema.org', '@type': 'CollectionPage', 'name': 'Karya Saya' }
      },
      howWeWork: {
      ...
      articles: {
        title: 'Artikel | riizalhp. - Wawasan Web Dev & Strategi Digital',
        description: 'Baca artikel saya tentang pengembangan web, tren desain, SEO, dan strategi bisnis digital untuk tetap terdepan di dunia digital.',
        keywords: 'blog pengembangan web, strategi digital, tips seo, artikel riizalhp',
        ogImage: 'https://riizalhp.web.id/images/og-riizalhp-articles.jpg',
    ...
    pricing: {
      ...
      packages: {
        personal: [
          { name: 'Ekonomi Personal', description: 'Untuk mahasiswa atau fresh graduate yang butuh profil online simpel.', originalPrice: 'Rp 799.900', price: 'Rp 499.900', priceNote: '', features: ['Domain gratis (.my.id/.web.id/.site/.online)', 'Upgrade domain: .com (+Rp310k), .id (+Rp390k)', 'Landing Page (bagian custom)', 'Desain Template Premium', 'Desain responsif & mobile-friendly', 'Formulir Kontak (WA/Email)', '2x Revisi minor', 'Gratis hosting 12 bulan', '3 bulan pemeliharaan'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.my.id/.web.id)', 'Template', '—', '2x Minor', '—', '1 Tahun', 'Custom', '1 Halaman', '3 Bulan'] },
          { name: 'Starter Personal', description: 'Untuk individu yang mulai serius membangun personal brand.', originalPrice: 'Rp 2.499.000', price: 'Rp 1.499.000', priceNote: '', features: ['Domain gratis (.my.id/.web.id)', 'Upgrade domain: .com (+Rp310k), .id (+Rp390k)', 'Landing Page (bagian custom)', 'Desain custom sesuai brand', 'SEO Dasar', 'Integrasi Google Analytics', '3x Revisi minor', 'Gratis hosting 12 bulan', '3 bulan pemeliharaan'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.my.id/.web.id)', 'Custom', 'Dasar', '3x Minor', '✓', '1 Tahun', 'Custom', '1 Halaman', '3 Bulan'] },
          { name: 'Bisnis Personal', description: 'Untuk freelancer, tutor, atau personal brand yang ingin tampil profesional.', originalPrice: 'Rp 4.999.000', price: 'Rp 2.999.900', priceNote: '', popular: true, features: ['Domain premium .com atau .id', 'Website multi-halaman (Home, About, dll)', 'Blog mini untuk artikel', 'Desain custom sesuai brand', 'Optimisasi SEO lengkap', 'Integrasi Google Analytics', '5x Revisi minor + 1x Mayor', 'Gratis hosting 12 bulan', '1 tahun pemeliharaan & support penuh'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.com atau .id)', 'Custom', 'Lengkap', '5x Minor + 1x Mayor', '✓', '1 Tahun', 'Custom', 'Multi-halaman', '1 Tahun'] },
          { name: 'Custom Personal', description: 'Untuk content creator atau brand besar dengan kebutuhan spesifik.', originalPrice: 'Rp 9.999.000', price: 'Rp 5.999.900', priceNote: 'Mulai dari', features: ['Domain premium pilihan (.com, .id, .ai, dll)', 'Fitur custom sesuai kebutuhan', 'Desain custom sesuai brand', 'Keamanan tingkat lanjut', 'Revisi minor tak terbatas + 2x Mayor', 'Gratis hosting 12 bulan', '1 tahun pemeliharaan & support penuh'], buttonText: 'Hubungi Kami', comparisonValues: ['✓ (Premium)', 'Full Custom', 'Ditingkatkan', 'Tak Terbatas', '✓', '1 Tahun', 'Custom', 'Custom', '1 Tahun'] }
        ],
        sme: [
          { name: 'Ekonomi UKM', description: 'Untuk UKM baru atau usaha kecil yang ingin hadir online.', originalPrice: 'Rp 999.000', price: 'Rp 499.900', priceNote: '', features: ['Domain gratis (.my.id/.web.id/.site/.online)', 'Upgrade domain: .com (+Rp310k), .id (+Rp390k)', 'Landing Page (bagian custom)', 'Desain template siap pakai', 'Desain responsif & mobile-friendly', 'Formulir Kontak (WA/Email)', '2x Revisi minor', 'Gratis hosting 12 bulan', '3 bulan pemeliharaan'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.my.id/.web.id)', 'Template', '—', '2x Minor', '—', '1 Tahun', 'Custom', '1 Halaman', '3 Bulan'] },
          { name: 'Starter UKM', description: 'Untuk UKM yang siap serius menjangkau pelanggan online.', originalPrice: 'Rp 3.499.000', price: 'Rp 1.999.000', priceNote: '', features: ['Domain gratis (.my.id/.web.id)', 'Upgrade domain: .com (+Rp310k), .id (+Rp390k)', 'Landing Page lengkap (bagian custom)', 'Desain custom sesuai brand', 'Formulir Order (WA/Email)', 'SEO Dasar', 'Integrasi Google Analytics', '3x Revisi minor', 'Gratis hosting 12 bulan', '3 bulan pemeliharaan'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.my.id/.web.id)', 'Custom', 'Dasar', '3x Minor', '✓', '1 Tahun', 'Custom', '1 Halaman', '3 Bulan'] },
          { name: 'Bisnis UKM', description: 'Pilihan terbaik untuk UKM yang butuh website lebih profesional.', originalPrice: 'Rp 6.999.000', price: 'Rp 3.999.000', priceNote: '', popular: true, features: ['Domain premium .com atau .id', 'Website multi-halaman', 'Katalog produk simpel / booking online', 'Desain custom sesuai brand', 'Formulir kontak & order', 'Optimisasi SEO lengkap', 'Integrasi Google Analytics', '5x Revisi minor + 1x Mayor', 'Gratis hosting 12 bulan', '1 tahun pemeliharaan & support penuh'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.com atau .id)', 'Custom', 'Lengkap', '5x Minor + 1x Mayor', '✓', '1 Tahun', 'Custom', 'Multi-halaman', '1 Tahun'] },
          { name: 'Custom UKM', description: 'Solusi premium untuk UKM dengan fitur lengkap sesuai kebutuhan.', originalPrice: 'Rp 14.999.000', price: 'Rp 7.999.900', priceNote: 'Mulai dari', features: ['Domain premium pilihan (.com, .id, .store, dll)', 'Fitur custom (marketplace, payment gateway, dll)', 'Desain full custom', 'Keamanan tingkat lanjut & backup otomatis', 'Revisi minor tak terbatas + 2x Mayor', 'Gratis hosting 12 bulan', '1 tahun pemeliharaan & support penuh'], buttonText: 'Hubungi Kami', comparisonValues: ['✓ (Premium)', 'Full Custom', 'Ditingkatkan', 'Tak Terbatas', '✓', '1 Tahun', 'Custom', 'Custom', '1 Tahun'] }
        ],
        enterprise: [
          { name: 'Ekonomi Enterprise', description: 'Untuk perusahaan atau organisasi kecil yang butuh profil online.', originalPrice: 'Rp 1.499.000', price: 'Rp 749.000', priceNote: '', features: ['Domain gratis (.my.id/.web.id/.site/.online)', 'Upgrade domain: .com (+Rp310k), .co.id (+Rp465k)', 'Landing Page (bagian custom)', 'Desain template profesional', 'Desain responsif & mobile-friendly', 'Formulir Kontak', '2x Revisi minor', 'Gratis hosting 12 bulan', '3 bulan pemeliharaan'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.my.id/.web.id)', 'Template', '—', '2x Minor', '—', '1 Tahun', 'Custom', '1 Halaman', '3 Bulan'] },
          { name: 'Starter Enterprise', description: 'Untuk perusahaan yang ingin menampilkan profil resmi profesional.', originalPrice: 'Rp 6.499.000', price: 'Rp 3.499.000', priceNote: '', features: ['Domain premium .co.id atau .id', 'Website multi-halaman', 'Bagian khusus korporat', 'Desain custom sesuai branding korporat', 'Optimisasi SEO dasar', 'Integrasi Google Analytics', '3x Revisi minor', 'Gratis hosting 12 bulan', '3 bulan pemeliharaan'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.co.id atau .id)', 'Custom', 'Dasar', '3x Minor', '✓', '1 Tahun', '✓', 'Multi-halaman', '3 Bulan'] },
          { name: 'Bisnis Enterprise', description: 'Pilihan terbaik untuk perusahaan menengah dengan fitur interaktif.', originalPrice: 'Rp 12.999.000', price: 'Rp 7.499.900', priceNote: '', popular: true, features: ['Domain premium .co.id atau .id', 'Website multi-halaman (termasuk Karir)', 'Fitur opsional (Login, Booking, Ticketing)', 'Desain custom sesuai brand guidelines', 'Optimisasi SEO lengkap', '5x Revisi minor + 1x Mayor', 'Gratis hosting 12 bulan', '1 tahun pemeliharaan & support penuh'], buttonText: 'Pilih Paket', comparisonValues: ['✓ (.co.id atau .id)', 'Custom', 'Lengkap', '5x Minor + 1x Mayor', '✓', '1 Tahun', 'Custom', 'Multi-halaman', '1 Tahun'] },
          { name: 'Custom Enterprise', description: 'Solusi premium untuk perusahaan besar dengan sistem website custom.', originalPrice: 'Rp 24.999.000', price: 'Rp 14.999.000', priceNote: 'Mulai dari', features: ['Domain premium sesuai kebutuhan', 'Fitur custom (Sistem HR, Project Mgmt, SaaS, dll)', 'Desain full custom', 'Keamanan level enterprise', 'Revisi minor tak terbatas + 2x Mayor', 'Gratis hosting 12 bulan', '1 tahun pemeliharaan & support penuh'], buttonText: 'Hubungi Kami', comparisonValues: ['✓ (Premium)', 'Full Custom', 'Level Enterprise', 'Tak Terbatas', '✓', '1 Tahun', 'Custom', 'Custom', '1 Tahun'] }
        ]
      },
      products: {
